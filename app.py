...
#Definirem aqui tots els components com a variables per a tal d'accedir-hi en qualsevol moment en el programa
    ...
    async def update_cards():
        ...
        if len(cards) == 0 or canvi == True:
                ...
                llocs = Llocs(41.446081380886504,2.2491992381345103,radius_sel,25,loc_visited,categories_sel,sort_sel, preu) #! Problema, dona sempre el mateix BUG-5
                ...
                for i in range(len(dadesLlocs)):
                    ...
                    print("Carta creada")
                    carta = Container(
                            image_src = "https://i.imgur.com/Kc6KkMt.jpeg", #! Canviar-la a l'assets
                            image_fit = "FILL",
                            offset=(0,0),
                            border_radius=15, 
                            width = page.width,
