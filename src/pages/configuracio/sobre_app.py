"""Sobre l'aplicació: /configuracio/sobre_app"""
from flet import AppBar, Divider, FontWeight, SafeArea, Text, TextThemeStyle, View
...
async def build_view(page, ctx):
    page.views.append(View(
        ...
        controls=[
            ...
            Divider(),
            Text(
                "Fet per: Marc Lumbreras Torregrosa \n"
                " Fet com a part pràctica del Treball de Recerca a Batxillerat, 2024-2025",
                text_align="center",
                weight=FontWeight.W_300,
                theme_style=TextThemeStyle.BODY_SMALL,
                width=page.width,
