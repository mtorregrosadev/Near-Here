from flet import View, Column, ExpansionTile, Checkbox, Text, FontWeight, Colors, TileAffinity, ElevatedButton, SafeArea, AppBar
from src.constants import CATEGORIES_LIST

def categories_view(page, APP_SESSIONS, view_pop, categ_check_sel):
    ...
    categ_info_add = Column(scroll="adaptive", height=page.height * 0.85, horizontal_alignment="center", controls=[
        Categ_info,
        ExpansionTile(
